...
VLAN_CLI_ID="25"
VLAN_MGMT_ID="99"
IP_VLAN_SRV="172.16.15.1/27"
IP_VLAN_CLI="172.16.25.1/28"
IP_VLAN_MGMT="172.16.99.1/29"
HOSTNAME="hq-rtr.au-team.irpo"
TIME_ZONE="Asia/Novosibirsk"
USERNAME="net_admin"
USER_UID=1010
BANNER_TEXT="Authorized access only"
TUNNEL_LOCAL_IP="172.16.40.2"
TUNNEL_REMOTE_IP="172.16.50.2"
TUNNEL_IP="172.16.100.1/28"
TUNNEL_NAME="gre1"
DHCP_VLAN_CLI="${INTERFACE_VLAN_BASE}.${VLAN_CLI_ID}"
DHCP_SUBNET="192.168.25.0"
DHCP_NETMASK="255.255.255.240"
DHCP_RANGE_START="192.168.25.10"
DHCP_RANGE_END="192.168.25.11"
DHCP_DNS="172.16.15.2"
